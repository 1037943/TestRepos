...
USER root
# Copy config files
COPY Deployment/InitW1/RegressionComponent/appserver/standalone-full.xml /opt/jboss/wildfly/standalone/configuration
COPY Deployment/InitW1/RegressionComponent/scripts/startservers.sh /home
# Create necessary directories and set permissions
ADD Deployment/InitW1/RegressionComponent/runtimeconfig/ConfigDir /home/ConfigDir
