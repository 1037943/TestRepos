...
USER root
# Copy config files
COPY Deployment/InitW1/SpringBootDemo/appserver/standalone-full.xml /opt/jboss/wildfly/standalone/configuration
COPY Deployment/InitW1/SpringBootDemo/scripts/startservers.sh /home
