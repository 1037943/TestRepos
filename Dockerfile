...
USER root
# Copy config files
COPY Deployment/InitW1/TestAssemblyNew/appserver/standalone-full.xml /opt/jboss/wildfly/standalone/configuration
COPY Deployment/InitW1/TestAssemblyNew/scripts/startservers.sh /home
# Create necessary directories and set permissions
ADD Deployment/InitW1/TestAssemblyNew/runtimeconfig/ConfigDir /home/ConfigDir
